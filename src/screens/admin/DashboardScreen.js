...
const DashboardScreen = ({ navigation }) => {
  ...
  const todayCounts = useMemo(() => {
    ...
    // Calculate total CNG needed for today
    const todaysCngTotal = todays.reduce((sum, booking) => {
      return sum + (booking.cngQuantity || 0);
    }, 0);
    
    return { 
      todayTotal: todays.length, 
      upcomingTotal: upcoming.length,
      todaysCng: todaysCngTotal
    };
  }, [recentBookings]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        {/* CNG Requirement Card */}
        <View style={styles.cngCard}>
          <View style={styles.cngHeader}>
            <Icon name="gas-cylinder" size={20} color={colors.primary} />
            <Text style={styles.cngTitle}>Today's CNG Requirement</Text>
          </View>
          <View style={styles.cngValueContainer}>
            <Text style={styles.cngValue}>{todayCounts.todaysCng}</Text>
            <Text style={styles.cngUnit}>kg</Text>
          </View>
          <Text style={styles.cngSubtext}>
            Total CNG needed for {todayCounts.todayTotal} booking{todayCounts.todayTotal !== 1 ? 's' : ''} today
          </Text>
        </View>
            ...
            <View style={styles.bookingRow}>
              <View style={styles.bookingInfo}>
                ...
                <View style={styles.bookingDetails}>
                  ...
                  <Text style={styles.bookingSlot}>{item.slot}</Text>
                  {item.cngQuantity && (
                    <Text style={styles.bookingCng}>
                      <Icon name="gas-cylinder" size={12} color={colors.textSecondary} /> {item.cngQuantity} kg
                    </Text>
                  )}
                </View>
              </View>
