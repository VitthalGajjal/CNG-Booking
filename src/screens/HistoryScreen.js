...
//         .limit(10) // Fetch only latest 10 bookings
//         .get();
...
//     // Set up real-time listener for latest 10 bookings
//     const unsubscribe = firestore()
//       .collection('bookings')
//       .where('userId', '==', userId)
//       .orderBy('timestamp', 'desc')
//       .limit(10) // Real-time updates for latest 10 bookings only
//       .onSnapshot(
//         querySnapshot => {
...
//             </Text>
//             {bookings.length === 10 && (
//               <Text style={styles.limitText}>(Latest 10 bookings)</Text>
//             )}
//           </View>
//           <FlatList
//             data={bookings}
